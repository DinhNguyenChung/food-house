...
Bàn: ${tableInfo.tableId}
Khách hàng: ${tableInfo.customerName}
Số món: ${cart.length}
            ...
            <div className="flex-1 p-5 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button
                  ...
                  className="w-10 h-10 bg-[#00D4FF] text-white rounded-full flex items-center justify-center hover:bg-accent/90 transition-colors"
                >
                  <FaPlus />
                </button>
              </div>
