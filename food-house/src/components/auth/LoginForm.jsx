...
const LoginForm = ({ show, handleClose, handleLogin, handleOpenSignUp }) => {
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');

  const handleSubmit = (e) => {
    e.preventDefault();
    handleLogin({ email, name: email.split('@')[0] }); // Simplified login
  };
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative">
                  <button 
                    className="bg-cyan-500 text-white rounded-md px-4 py-2 w-full hover:bg-cyan-600 transition-colors"
